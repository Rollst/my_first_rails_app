...
class HorsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post horses_url, params: { horse: { make: @horse.make, model: @horse.model, year: @horse.year } }
    end
  ...
  test "should update horse" do
    patch horse_url(@horse), params: { horse: { make: @horse.make, model: @horse.model, year: @horse.year } }
